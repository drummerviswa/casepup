          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <p className="text-lg mt-8 lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                Craft a phone case that reflects your{" "}
                <span className="font-semibold">
                  style, passion, and personality
                </span>
                . Whether bold, elegant, or quirky, we’ve got you covered! phone
                case that reflects your personality.
              ...
              <ul className="mt-8 space-y-2 text-left font-medium flex flex-col items-center sm:items-start">
                <div className="space-y-2">
                  <li className="flex gap-1.5 items-center text-left">
                    ...
                    🌱 Eco-Friendly Materials: Protect your phone while
                    protecting the planet.{" "}
                  </li>
                  <li className="flex gap-1.5 items-center text-left">
                    <Check className="text-primary w-5 h-5 shrink-0" />✨
                    Vibrant, Crystal-Clear Prints: Colors that last a
                    lifetime—guaranteed.{" "}
                  </li>
                  <li className="flex gap-1.5 items-center text-left">
                    <Check className="text-primary w-5 h-5 shrink-0" />
                    🎨 Endless Design Options: Choose from a wide variety or
                    create your own masterpiece.{" "}
                  </li>
                  <li className="flex gap-1.5 items-center text-left">
                    <Check className="text-primary w-5 h-5 shrink-0" />
                    🖌️ Intuitive Design Platform: Easy tools to bring your ideas
                    to life in minutes.{" "}
                  </li>
                  <li className="flex gap-1.5 items-center text-left">
                    <Check className="text-primary w-5 h-5 shrink-0" />
                    🚀 Fast & Affordable Shipping: Your design, delivered
              ...
              <div className="mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5">
                ...
                <div className="flex flex-col justify-between items-center sm:items-start">
                  ...
                  <p className="text-sm">
                    <span className="font-semibold">2.701K</span> happy customers
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
            <h2 className="order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl sm:text-6xl">
              ...
              <span className="relative px-2">
                customers{" "}
                <Icons.underline className="stroke-primary hidden sm:block pointer-events-none absolute inset-x-0 -bottom-6 text-rose-600" />
              </span>{" "}
              say
            </h2>
            <Image
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                "Absolutely love my custom phone case! The design is perfect, and the print quality is top-notch. It fits my phone flawlessly and feels incredibly durable. Highly recommend!"
                </p>
              </div>
              <div className="flex gap-4 mt-2">
                ...
                <div className="flex flex-col">
                  <p className="font-semibold">Vaibav R</p>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                "Couldn't be happier with my custom phone case! The design exceeded my expectations, the print quality is fantastic, and the case feels incredibly sturdy. It fits my phone perfectly. Highly recommend!"                </p>
              </div>
              <div className="flex gap-4 mt-2">
                <Image
                  src="/users/2.jpg"
                ...
                />
                <div className="flex flex-col">
                  <p className="font-semibold">Danya R</p>
                  <div className="flex gap-1.5 items-center text-muted-foreground">
                    <BadgeCheck className="w-4 h-4 text-primary" />
                    <p className="text-sm">Verified Purchase</p>
                  </div>
